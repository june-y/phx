defmodule TestWeb.OrderControllerTest do
  ...
  @create_attrs %{is_delivered: true, not_deliverable: true, order_number: 42, patient_address: "some patient_address", patient_name: "some patient_name", pickup_date: ~D[2010-04-17], pickup_time: ~T[14:00:00.000000]}
  ...
  describe "update order" do
    ...
    test "redirects when data is valid", %{conn: conn, order: order} do
      ...
      assert html_response(conn, 200) =~ "some updated patient_address"
    end
